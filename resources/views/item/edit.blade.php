            ...
            <div class="card">
                ...
                <form action="{{route('itemUpdate')}}" method="post">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="quantity" type="number" class="form-control @error('number') is-invalid @enderror" name="quantity" value="{{$item->quantity }}" required autocomplete="quantity">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="manufactureDate" type="date" class="form-control @error('number') is-invalid @enderror" name="manufactureDate" value="{{$item->manufacture_date }}" required autocomplete="manufactureDate">
